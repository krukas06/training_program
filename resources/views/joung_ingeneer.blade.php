...
<img class="card-img-top" style="width: 40%; margin-left: 40px; margin-top: 40px;" src="{{ asset('img/4.jpg')}}" alt="Card image cap">
<div class="card-body" style="margin-left: 48%; margin-top: 10px;">
    <h1 class="card-title">Школа юный инженер</h1>

</div>

<div style="margin-left: 300px; margin-right: 80px; width: 1300px; margin-bottom: 20px">
    <p style="text-align: justify; line-height: normal ">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium corporis, cum error ex explicabo id illo iste laudantium nemo numquam quam quibusdam quisquam suscipit voluptate voluptatum. Autem eum natus neque
        <!doctype html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
...
<div style="margin-left: 300px; margin-right: 80px; width: 1300px; margin-bottom: 20px">
    <p style="text-align: justify; line-height: normal "> <h4>Преподаватель: ФИО преподавателя</h4> </p>
</div>
...
<div class="modal fade" id="modalRegisterForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="/add_order_ing" method="post">
                <div class="modal-body mx-3">
                    {{csrf_field()}}

                    {{--<input type="hidden" name="id" value="{{$lessons->id}}">--}}
                    <input type="hidden" name="name_curs" value="Юный инженер">
